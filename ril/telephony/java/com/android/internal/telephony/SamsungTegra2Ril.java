...
public class SamsungTegra2RIL extends RIL implements CommandsInterface {
    ...
    protected HandlerThread mSamsungTegra2RILThread;
    protected ConnectivityHandler mSamsungTegra2RILHandler;
    private AudioManager audioManager;
    private boolean mIsGBModem = SystemProperties.getBoolean("ro.ril.gbmodem", false);

    public SamsungTegra2RIL(Context context, int networkMode, int cdmaSubscription) {
    ...
    public void setPreferredNetworkType(int networkType , Message response) {
        ...
        if(NeedReconnect())
        {
            if (mSamsungTegra2RILHandler == null) {

                handlerThread = new HandlerThread("mSamsungTegra2RILThread");
                mSamsungTegra2RILThread = handlerThread;

                mSamsungTegra2RILThread.start();

                looper = mSamsungTegra2RILThread.getLooper();
                mSamsungTegra2RILHandler = new ConnectivityHandler(mContext, looper);
            }
            mSamsungTegra2RILHandler.setPreferedNetworkType(networkType, response);
        } else {
            if (mSamsungTegra2RILHandler != null) {
                mSamsungTegra2RILThread = null;
                mSamsungTegra2RILHandler = null;
            }
